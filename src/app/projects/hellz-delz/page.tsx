...
import { FaCode, FaPalette, FaExternalLinkAlt, FaDog, FaPaw } from 'react-icons/fa';

export default function HellzDelzProject() {
  return (
    <ProjectLayout title="HellzDelz Dog Training">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <h2 className="text-2xl font-bold mb-4 text-blue-400">Professional Dog Training Services</h2>
            <a 
              href="https://hellzdelz.com" 
              target="_blank" 
        ...
        <div className="mt-8 overflow-hidden rounded-lg shadow-lg transition-transform hover:scale-[1.02]">
          <Image
            src="/portfolio/hellz-delz-screenshot.png"
            alt="HellzDelz Dog Training Website Screenshot"
            width={1200}
            height={675}
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="prose prose-lg max-w-none text-gray-300">
              <p>
                The core of HellzDelz Dog Training is its machine learning system, which was trained on anonymized data from 
